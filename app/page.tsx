    ...
    <div className="min-h-screen">
      <section className="flex flex-col items-center justify-center px-4 pt-24 pb-16 text-center">
        ...
        <p className="mt-6 max-w-xl text-lg text-muted-foreground">
          ...
          help that teaches the right things, the right way—aligned with
          what&apos;s actually being taught in class.
        </p>
      ...
      <section className="px-4 py-16 border-t">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              AI tools are everywhere in education now—but they&apos;re teaching
              students the wrong things. Generic AI tutors don&apos;t know your
              curriculum. They give answers without proper explanation. They
              skip steps. They overstep.
            </p>
            <p>
              Meanwhile, homework has stopped being useful. When students can
              get answers from AI, teachers lose visibility into how their
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Upload assignments, lecture notes, and curriculum materials to
                  your class space.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-medium">
                  Teachers see what&apos;s happening
                </h3>
                <p className="text-muted-foreground mt-1">
                  Get insights into how students are actually engaging with
                  material. Homework becomes useful again.
                </p>
              </div>
            </div>
          </div>
